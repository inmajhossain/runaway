    ...
    <span className={className}>
      {letters.map((letter, i) => {
        return (
          <span
            key={i}
            className="inline-block relative [perspective:10000px] [transform-style:preserve-3d] [width:auto]"
            aria-hidden="true"
          >
            <motion.span
              className="inline-block absolute [backface-visibility:hidden] [transform-origin:50%_25%]"
              initial={
            ...
            <motion.span
              className="inline-block absolute [backface-visibility:hidden] [transform-origin:50%_100%]"
